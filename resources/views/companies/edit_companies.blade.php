...
@section('title', 'Edit Companies - Laravel Auth')
                ...
                << Back</a>
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="card-header">{{ __('Form Edit Company') }}</div>
                            ...
                            <div class="card p-2">
                                ...
                                <form class="form-horizontal" method="post"
                                    action="/edit_companies/{{ $companies->id }}">
                                    @method('patch')
                                    @csrf
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <input id="name" type="text"
                                                ...
                                                placeholder="Company name..." value="{{ $companies->name }}">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <input id="email" type="email"
                                                ...
                                                placeholder="Company email..." value="{{ $companies->email }}">
                                        </div>
                                    </div>
                                    <div class="form-group">
